...
class CategoriesBlockService extends AbstractBlockService
{
    ...
    public function execute(BlockContextInterface $blockContext, Response $response = null)
    {
        ...
        $query = $this->em->createQuery("SELECT count(c.id) as total, c.name, c.slug FROM WixetBlogBundle:Category c JOIN c.locale l JOIN c.entry e WHERE e.public = true AND l.locale LIKE :locale GROUP BY c.id");
